...
')
     ...
     */ 
        ...
        {
                        /** @var \Savannabits\Koaladmin\Koaladmin $instance */
        ...
        {            //Method inherited from \Symfony\Component\Console\Command\Command         
                        return \Savannabits\Koaladmin\Koaladmin::getDefaultName();
        }
                    /**
         ...
         * @return \Savannabits\Koaladmin\Koaladmin 
         * @throws InvalidArgumentException
         * @see execute()
         * @static 
         */ 
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \Illuminate\Console\Command         
                        \Savannabits\Koaladmin\Koaladmin::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \Illuminate\Console\Command         
                        \Savannabits\Koaladmin\Koaladmin::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \Illuminate\Console\Command         
                        return \Savannabits\Koaladmin\Koaladmin::hasMacro($name);
        }
...
namespace  { 
            ...
            class Koaladmin extends \Savannabits\Koaladmin\KoaladminFacade {}
