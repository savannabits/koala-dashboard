...
@section('content')
    ...
    >
        <div class="flex justify-between items-center">
            ...
            @can('authors.create')
            <button type="button" x-on:click="createAuthor" class="btn p-2 text-current bg-primary text-gray-50 rounded">
                <i class="fas fa-plus mr-2"></i>Create New Author
            </button>
            @endcan
        </div>
        @can('authors.index')
        ...
        <form id="author-create-form" novalidate x-on:submit.prevent="storeAuthor">
            <x-koala.modal size="2xl" class="text-primary" id="create-author-modal">
                <x-slot name="title">
                    <h2 x-text="`Create New Author`"></h2>
                </x-slot>
